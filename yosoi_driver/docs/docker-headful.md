...
└────────────────────────────────────────────────────────┘
         ...
         ▼                              ▼
┌──── Your host ──────────────────────────────────────────┐
│  yosoi_driver connects to localhost:19222 via CDP       │
...
| `localhost:19222` | CDP | yosoi_driver connects here to control Chrome browser 1 |
| `localhost:19223` | CDP | yosoi_driver connects here to control Chrome browser 2 |

## Connecting yosoi_driver to Docker Chrome

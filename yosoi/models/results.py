...
class FieldVerificationResult(BaseModel):
    ...
    selector_level: Literal['css', 'xpath', 'regex', 'jsonld', 'role', 'visual', 'attr', 'global_id'] | None = Field(
        default=None,
        description='Strategy level that worked (css/xpath/regex/jsonld/role/visual/attr/global_id)',
    )

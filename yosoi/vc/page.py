...
async def page(url: str, *, config: SessionConfig | None = None, **kwargs: Any) -> AsyncIterator[Page]:
    ...
    Example::
        ...
        async with vc.page('https://example.com') as pg:
    ...
    Yields:
        A :class:`~void_crawl.Page` that is closed on exit.
...
async def pages(*urls: str, config: SessionConfig | None = None, **kwargs: Any) -> AsyncIterator[tuple[Page, ...]]:
    ...
    Example::
        ...
        async with vc.pages('https://a.com', 'https://b.com') as (p1, p2):
    ...
    Yields:
        A tuple of :class:`~void_crawl.Page` objects, closed on exit.

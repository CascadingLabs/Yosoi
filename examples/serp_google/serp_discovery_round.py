...
Run (needs a provider key in the environment, or pass --model):
    uv run --all-extras python examples/serp_google/serp_discovery_round.py
    uv run --all-extras python examples/serp_google/serp_discovery_round.py --model openai:gpt-4o
    uv run --all-extras python examples/serp_google/serp_discovery_round.py --model ollama:llama3.1
"""

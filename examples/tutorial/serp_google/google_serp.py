...
Run:
    uv run python examples/tutorial/serp_google/google_serp.py            # offline demo (default)
    uv run python examples/tutorial/serp_google/google_serp.py --queries 30
    uv run python examples/tutorial/serp_google/google_serp.py --real     # prints the live-path status
"""

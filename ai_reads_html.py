...
Discovering selectors for: https://virginiabusiness.com/...
================================================================================

Step 1: Fetching HTML...
✓ Fetched 156732 characters of HTML

Step 2: AI analyzing HTML to find selectors...
✓ AI found selectors:
{
  "headline": {
    "primary": "h1.news-page-header",
    "fallback": "h2.news-page-header",
    "tertiary": "h1"
  },
  "author": {
    "primary": "a[href*='/author/']",
...
Step 3: Validating selectors on actual page...
  ...
  Testing headline:
    ✓ primary: 'h1.news-page-header' → "New documents reveal scope of Google's..."
    ✓ fallback: 'h2.news-page-header' → "New documents reveal scope of Google's..."
  → Using primary selector: 'h1.news-page-header'

  Testing author:
    ✓ primary: 'a[href*='/author/']' → "Josh Janney"
  → Using primary selector: 'a[href*='/author/']'

✓ Successfully discovered 5 working field selectors
✓ Saved to selectors/selectors_virginiabusiness_com.json
...
OLD APPROACH:
1. AI extracts content (hallucinates)
2. Search HTML for that content (fails)
3. Generate selectors (wrong)

NEW APPROACH:
1. Give AI the actual HTML
2. AI reads it and finds selectors
3. We test those selectors
...
AI is BAD at:
✗ Extracting exact text (summarizes)
✗ Consistency

So let AI do what it's good at!
"""
